...
!
   ...
   allocate(sendArray(sizeOfMessage,sizeOfMessage))
   allocate(receiveArray(sizeOfMessage,nrOfProcs*sizeOfMessage))
...
!
   ...
   do j=1,sizeOfMessage
      sendArray(i,j) = dble(myRank)
    !  receiveArray(i,sizeOfMessage*myRank+i) = sendArray(i)
